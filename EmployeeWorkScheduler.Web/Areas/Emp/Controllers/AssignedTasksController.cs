...
namespace EmployeeWorkScheduler.Web.Areas.Emp.Controllers
{
    ...
    public class AssignedTasksController : Controller
    {
        ...
        {
            ViewData["ManagerId"] = new SelectList(_context.Admins, "ManagerId", "Confirmpwd");
            ViewData["EmpId"] = new SelectList(_context.Employees, "EmpId", "Confirmpwd");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("TaskId,Description,AssignedDate,DueDate,Status,EmpId,ManagerId")] AssignedTask assignedTask)
        {
            ...
            ViewData["ManagerId"] = new SelectList(_context.Admins, "ManagerId", "Confirmpwd", assignedTask.ManagerId);
            ViewData["EmpId"] = new SelectList(_context.Employees, "EmpId", "Confirmpwd", assignedTask.EmpId);
            return View(assignedTask);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TaskId,Description,AssignedDate,DueDate,Status,EmpId,ManagerId")] AssignedTask assignedTask)
        {
